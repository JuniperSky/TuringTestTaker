 ...
 * @param fileName The file name tells us what file to use.
 */
  ...
  /**
 * This determines what kind of sentence the result will be. Or, more 
 *     specifically, what kind of sentence maker will be used.
 */
  ...
  /**
   * This creates a user-friendly network of words from the text file.
 * @throws IOException Specifically, when the file isn't found.
 */
    ...
    while (currentLine != null) {
      ...
      if (currentLine.equals("***")) {
        ...
        WeightedWord newWeightedWord = new WeightedWord(splitLine[0], 
            Double.valueOf(splitLine[1]), splitLine[2]);
  ...
  /**
   * This updates a word network with new words.
 * @param wordNetwork The word network is a set of word associations to be added to and updated.
 */
  ...
  /**
 * This updates the greater network (with new data from the user), just as the name says.
 */
  public void updateGreaterNetwork() {
    //This method updates the network of word categories we created from the text file, so that we
    //can then use it to update the text file.
  ...
  /**
   * This determines the words that will be part of the final sentence.
 * @throws IOException This throws an exception, since it involves reading a file.
 */
  public void getRelevantWords() throws IOException {
    ...
    formGreaterNetwork();
    //Next, we initialize some word networks (lists of weighted words, essentially) to hold the
    //words we might potentially use.
    ...
    //So, now that we have all the potential words and their weights sorted out, we go through each
    //of the "potential" lists we created and find which word has the highest accumulated weight. If
  ...
  /**
 * @throws IOException This updates the text file afterwards, but there will be an exception if
 ...
 */
  ...
  /**
 * @return This assembles the final sentence, and returns it as a single string.
 */
  public String assembleSentence() {
    //Now that we have all the relevant words, we just ask the sentence maker to arrange them.
