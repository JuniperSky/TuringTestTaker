...
public class GUIBuilder {
	...
	gui.chatLog1 = new JTextArea("testing", 10, 15);
	...
	gui.enterButton = new JButton("Enter Input");
	gui.enterButton.addActionListener(gui);
	gui.enterButton.setEnabled(false);
	gui.south.add(gui.enterButton);
    }
